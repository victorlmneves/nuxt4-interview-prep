...
// Harden links generated by MarkdownIt: enforce safe protocols and security attributes.
md.renderer.rules.link_open = function (tokens, idx, options, env, self) {
    const href = tokens[idx].attrGet('href') || '';

    // Allow only http, https, or protocol-relative URLs; neutralize others.
...
function renderMarkdownText(markdown: string): string {
    ...
    // Render markdown to HTML and sanitize before injecting via v-html
